...
import qpar.common.parser.ParseException;
import qpar.common.parser.Qbf_parser;
import qpar.common.parser.SimpleNode;
import qpar.common.parser.TokenMgrError;
...
public class Qbf {
	...
	public Qbf(final String filename) throws IOException {
		...
		this.dependencyGraphRoot = DependencyTreeFactory.getDependencyTree(this.root);
