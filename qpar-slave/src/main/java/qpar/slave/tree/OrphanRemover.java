...
public class OrphanRemover {
	...
	public OrphanRemover(final Node node) {
		this.root = node;
	...
	private void removeOrphans(final Node n) {
		if (n.isQuantifierNode() && !this.variables.contains(n.getVar())) {
